...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _components_prediction_prediction_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ./components/prediction/prediction.component */
    ...
    AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 4,
      vars: 0,
      consts: [[1, "navbar", "navbar-dark", "sticky-top", "bg-dark", "flex-md-nowrap", "p-0"], ["href", "#", 1, "navbar-brand", "col-sm-3", "col-md-2", "mr-0"]],
      ...
      directives: [_components_prediction_prediction_component__WEBPACK_IMPORTED_MODULE_1__["PredictionComponent"]],
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _components_named_entities_named_entities_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./components/named-entities/named-entities.component */
    "./src/app/components/named-entities/named-entities.component.ts");
    /* harmony import */


    var _components_sentiment_analysis_sentiment_analysis_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./components/sentiment-analysis/sentiment-analysis.component */
    ...
    var _components_prediction_prediction_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ./components/prediction/prediction.component */
    "./src/app/components/prediction/prediction.component.ts"); // added new
    // added new
    ...
    AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      ...
      providers: [],
      imports: [[_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_4__["AppRoutingModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClientModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"] // Added as the part of import 
      ]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, {
        declarations: [_app_component__WEBPACK_IMPORTED_MODULE_5__["AppComponent"], _components_named_entities_named_entities_component__WEBPACK_IMPORTED_MODULE_6__["NamedEntitiesComponent"], _components_sentiment_analysis_sentiment_analysis_component__WEBPACK_IMPORTED_MODULE_7__["SentimentAnalysisComponent"], _components_events_events_component__WEBPACK_IMPORTED_MODULE_8__["EventsComponent"], _components_prediction_prediction_component__WEBPACK_IMPORTED_MODULE_9__["PredictionComponent"]],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_4__["AppRoutingModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClientModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"] // Added as the part of import 
        ]
      });
    })();
  ...
  /***/
  function srcAppComponentsNamedEntitiesNamedEntitiesComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "NamedEntitiesComponent", function () {
      return NamedEntitiesComponent;
    });
    /* harmony import */
    ...
    var NamedEntitiesComponent = /*#__PURE__*/function () {
      function NamedEntitiesComponent() {
        _classCallCheck(this, NamedEntitiesComponent);
      }

      _createClass(NamedEntitiesComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }]);
    ...
    NamedEntitiesComponent.ɵfac = function NamedEntitiesComponent_Factory(t) {
      return new (t || NamedEntitiesComponent)();
    };

    NamedEntitiesComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      type: NamedEntitiesComponent,
      selectors: [["app-named-entities"]],
      decls: 2,
      vars: 0,
      template: function NamedEntitiesComponent_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "p");
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](NamedEntitiesComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppComponentsPredictionPredictionComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var src_app_models_Document__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! src/app/models/Document */
    "./src/app/models/Document.ts");
    /* harmony import */


    var _services_demo_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    ...
    function PredictionComponent_form_27_Template(rf, ctx) {
      if (rf & 1) {
        var _r6 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "form", 29);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function PredictionComponent_form_27_Template_form_ngSubmit_0_listener() {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function PredictionComponent_form_27_Template_textarea_ngModelChange_4_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r6);

          var ctx_r7 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r7.textDocument = $event;
        });
    ...
    function PredictionComponent_form_28_Template(rf, ctx) {
      if (rf & 1) {
        var _r9 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "form", 33);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function PredictionComponent_form_28_Template_form_ngSubmit_0_listener() {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function PredictionComponent_form_28_Template_input_ngModelChange_4_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r9);

          var ctx_r10 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r10.newspaperUrl = $event;
        });
    ...
    function PredictionComponent_form_29_div_10_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function PredictionComponent_form_29_Template(rf, ctx) {
      if (rf & 1) {
        var _r15 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "form", 33, 36);

        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function PredictionComponent_form_29_Template_form_ngSubmit_0_listener() {
          ...
          return ctx_r14.onUploadFile(_r11);
        });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function PredictionComponent_form_29_Template_input_change_5_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r15);

          var ctx_r16 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r16.fileChanged($event);
        });
    ...
    function PredictionComponent_option_40_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function PredictionComponent_option_46_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "option", 45);
    ...
    var PredictionComponent = /*#__PURE__*/function () {
      function PredictionComponent(demoService, sanitizer) {
      ...
      _createClass(PredictionComponent, [{
        ...
        value: function onToggle(value) {
          this.isTextOrLink = value; // Clear display

          this.textDocument = null;
          this.newspaperUrl = null;
          this.predictionsNer = null; // Clear the textbox
        ...
        key: "spansToMarkup",
        value: function spansToMarkup(documentResult, predictionTask) {
          var hash = documentResult.predictedNerText;
          var offset = 0;
          var original = documentResult.text; // This will hold the final results

          var _final = "";
          hash.forEach(function (predictions) {
            ...
            predictions.forEach(function (prediction) {
              ...
              if (tag != "O") {
                _final += "<mark data-entity='" + tag.toString().toLowerCase() + "'>" + word + "</mark>";
              } else {
                _final += word + " ";
              }
            });
          ...
          console.log(_final);
          return this.sanitizer.bypassSecurityTrustHtml(_final);
        }
      }, {
        key: "fileChanged",
        value: function fileChanged(event) {
          var files = event.target.files; //this.fileUploadEl.nativeElement.files;
        ...
        key: "onUploadFile",
        value: function onUploadFile(form) {
          var _this = this;
          ...
          this.demoService.upload(params).subscribe(function (data) {
            _this.downLoadFile(data, "text/csv", _this.file.name);
          }, function (error) {
            if (error.status == "200") {
              _this.downLoadFile(error.error.text, "text/csv", _this.file.name);
              ...
              console.log(error);
              _this.isError = true;
              _this.errorMesssage = error.error;
              _this.file = null;
            }
          });
        }
        ...
        value: function onSubmit() {
          ...
          if (this.isTextOrLink == '1' && this.textDocument) {
            ...
            console.log(params);
            this.demoService.getPrediction(params).subscribe(function (documentResult) {
              console.log(documentResult);
              _this2.predictionsNer = _this2.spansToMarkup(documentResult, src_app_models_Document__WEBPACK_IMPORTED_MODULE_1__["PredictionTask"].Ner);
            });
            ...
            if (this.newspaperUrl) {
              this.demoService.getPredictionLink(_params).subscribe(function (documentResult) {
                _this2.predictionsNer = _this2.spansToMarkup(documentResult, src_app_models_Document__WEBPACK_IMPORTED_MODULE_1__["PredictionTask"].Ner);
              }, function (error) {
                console.log(error);
              });
            }
          } else if (this.isTextOrLink == '3') {// FILE UPLOAD CODE
    ...
    PredictionComponent.ɵfac = function PredictionComponent_Factory(t) {
      return new (t || PredictionComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_demo_service__WEBPACK_IMPORTED_MODULE_2__["DemoService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_platform_browser__WEBPACK_IMPORTED_MODULE_3__["DomSanitizer"]));
    };
    ...
    PredictionComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      viewQuery: function PredictionComponent_Query(rf, ctx) {
        if (rf & 1) {
      ...
      template: function PredictionComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function PredictionComponent_Template_img_click_3_listener() {
            return ctx.show();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function PredictionComponent_Template_button_click_14_listener() {
            return ctx.hide();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function PredictionComponent_Template_button_click_20_listener() {
            return ctx.onToggle("1");
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function PredictionComponent_Template_button_click_22_listener() {
            return ctx.onToggle("2");
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function PredictionComponent_Template_button_click_24_listener() {
            return ctx.onToggle("3");
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function PredictionComponent_Template_select_ngModelChange_39_listener($event) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function PredictionComponent_Template_select_ngModelChange_45_listener($event) {
            return ctx.selectedDegree = $event;
          });
  ...
  /***/
  function srcAppComponentsSentimentAnalysisSentimentAnalysisComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    SentimentAnalysisComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](SentimentAnalysisComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
  ...
  /***/
  function srcAppModelsDocumentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "DocumentResult", function () {
      return DocumentResult;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "PredictionTask", function () {
      return PredictionTask;
    });

    var Document = // TBD
    function Document(ner, sentiment, event, text) {
      _classCallCheck(this, Document);
    };

    var DocumentResult = function DocumentResult() {
      _classCallCheck(this, DocumentResult);
    };
    ...
    var DemoService = /*#__PURE__*/function () {
      ...
      _createClass(DemoService, [{
        ...
        value: function getModels() {
          return this.http.get("".concat(this.demoUrl));
        }
      }, {
        key: "getPrediction",
        value: function getPrediction(document) {
          return this.http.post("".concat(this.demoUrl).concat(this.demoPredict), document, httpOptions);
        }
      }, {
        key: "getPredictionLink",
        value: function getPredictionLink(document) {
          return this.http.post("".concat(this.demoUrl).concat(this.demoLink), document, httpOptions);
        }
      }, {
        key: "upload",
        value: function upload(document) {
          ...
          return this.http.post("".concat(this.demoUrl).concat(this.demoFile), formData, {
            headers: headers
          });
        }
      }]);
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /media/gaurish/angela/projects/angular-crash-course/midas/midas-demonstrator/src/main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
